...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_postcss_jit_props: string;
	...
	export const npm_package_dependencies_groqd: string;
	...
	export const npm_package_devDependencies_kebab_case: string;
	...
	export const npm_package_devDependencies_stylelint_config_css_modules: string;
	...
	export const npm_package_dependencies_trpc_sveltekit: string;
	export const COMMAND_MODE: string;
	export const npm_package_devDependencies_postcss_preset_env: string;
	export const PNPM_SCRIPT_SRC_DIR: string;
	export const SSH_AUTH_SOCK: string;
	export const npm_package_devDependencies_stylelint_config_idiomatic_order: string;
	...
	export const npm_package_devDependencies_postcss_flexbugs_fixes: string;
	...
	export const npm_package_devDependencies__radix_ui_colors: string;
	...
	export const npm_package_dependencies__threlte_rapier: string;
	export const BAT_PAGER: string;
	export const SECURITYSESSIONID: string;
	export const npm_package_devDependencies__yushijinhun_three_minifier_rollup: string;
	export const npm_package_scripts_check: string;
	export const COLORTERM: string;
	export const npm_package_scripts_test_unit: string;
	export const npm_package_devDependencies_glyphhanger: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NVM_INC: string;
		npm_package_devDependencies_postcss_jit_props: string;
		...
		npm_package_dependencies_groqd: string;
		TERM_PROGRAM: string;
		NODE: string;
		NVM_CD_FLAGS: string;
		INIT_CWD: string;
		...
		TERM: string;
		SHELL: string;
		npm_package_devDependencies_kebab_case: string;
		...
		npm_package_devDependencies_stylelint_config_css_modules: string;
		...
		npm_package_dependencies_trpc_sveltekit: string;
		COMMAND_MODE: string;
		npm_package_devDependencies_postcss_preset_env: string;
		PNPM_SCRIPT_SRC_DIR: string;
		SSH_AUTH_SOCK: string;
		npm_package_devDependencies_stylelint_config_idiomatic_order: string;
		...
		npm_package_devDependencies_postcss_flexbugs_fixes: string;
		...
		npm_package_devDependencies__radix_ui_colors: string;
		...
		npm_package_dependencies__trpc_client: string;
		npm_package_scripts_test: string;
		npm_package_dependencies_three: string;
		HOMEBREW_PREFIX: string;
		npm_package_dependencies__trpc_server: string;
		...
		npm_package_dependencies__threlte_rapier: string;
		BAT_PAGER: string;
		SECURITYSESSIONID: string;
		npm_package_devDependencies__yushijinhun_three_minifier_rollup: string;
		npm_package_scripts_check: string;
		COLORTERM: string;
		npm_package_scripts_test_unit: string;
		npm_package_devDependencies_glyphhanger: string;
